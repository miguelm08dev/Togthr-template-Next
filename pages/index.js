...
`}
        ...
        <section className="home-customer">
          ...
          <div className="home-controls2">
            ...
            <Link href="/landing">
              <a className="home-link10 button">
                <span>
              ...
              <div className="home-links">
                <div className="home-column3">
                  ...
                  <div className="home-list1">
                    <Link href="/">
                      <a className="home-link11">About</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link12">Services</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link13">How</a>
                    </Link>
                    <Link href="/">
                ...
                <div className="home-column4">
                  ...
                  <div className="home-list2">
                    <Link href="/">
                      <a className="home-link15">News</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link16">Articles</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link17">Blog</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link18">Privacy</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link19">Terms</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link20">Legal</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link21">Press</a>
                    </Link>
                  </div>
                </div>
                <div className="home-column5">
                  ...
                  <div className="home-list3">
                    <Link href="/">
                      <a className="home-link22">LinkedIn</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link23">Twitter</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link24">Instagram</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link25">Facebook</a>
                    </Link>
                    <Link href="/">
                      <a className="home-link26">TikTok</a>
                    </Link>
                  </div>
                </div>
              </div>
